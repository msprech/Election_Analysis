...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes: 
        ...
        #county_results = (f"{county_name} had {county_vote_percentage:.1f}% of the total vote with {county_vote_count:,} votes")
        ...
        if (county_vote_count > highest_turnout_votes): 
            highest_turnout_county = county_name
            highest_turnout_votes = county_vote_count 
    ...
    highest_turnout_summary = (
        ...
        #f"Highest County Vote: {highest_turnout_votes:,}\n"
        f"-------------------------\n")    
